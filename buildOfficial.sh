...
docker rmi -f kabanero/kabanero-rest-services:0.11-rc.1
docker build -f build/Dockerfile -t kabanero/kabanero-rest-services:0.11-rc.1 .
docker push kabanero/kabanero-rest-services:0.11-rc.1
